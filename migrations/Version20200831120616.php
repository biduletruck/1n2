 ...
 */
final class Version20200831120616 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bbq_event ADD CONSTRAINT FK_4C19864DA515C82E FOREIGN KEY (new_bbq_id) REFERENCES bbq (id)');
    }
